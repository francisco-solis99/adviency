...
export function SnowBalls() {
  return (
    <div className="snowball__wrapper">
      <span className="snowball">
        <svg xmlns="http://www.w3.org/2000/svg" className="" width="28" height="28" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
